...
typedef struct task_para_set {
    ...
    INT16U TaskPeriodic;
    INT16U TaskNumber;
	INT16U TaskPriority; //紀錄現在的priority(有可能mutex改變)
    INT16U Now_TaskPriority; //紀錄現在的priority(有可能mutex改變)
	INT16U Blocking_T;
    INT8U  R1_start;
    INT8U  R1_end;
    INT8U  R2_start;
...
typedef struct os_tcb {
    ...
    INT8U            OSTCBPrio;             /* Task priority (0 == highest)  這會隨著mutex改變          */
    INT8U            OSTCBOriPrio;          /* Task priority (0 == highest)  這會隨著mutex改變(用來找taskparameter)*/
